<?php
/**
 * Plugin Name: Lazy Load Elementor background images
 * Description: Very lightweight but powerful Elementor add-on to Lazy Load background images
 * Author: Lily Danielyan
 * Version: 1.0.0
 *
 * Text Domain: elementor-lazy-load-background-images
 */

add_action('plugins_loaded', 'ElementorLazyLoadBackgroundImages::init');

class ElementorLazyLoadBackgroundImages
{
